...
internal static class Program
{
    ...
    {
        Console.WriteLine($"libitb3 {Everanium.Itb3.Runtime.Version()}");
        Console.WriteLine($"itb-csharp {Everanium.Itb3.Runtime.BindingVersion}");
        return 0;
    }
